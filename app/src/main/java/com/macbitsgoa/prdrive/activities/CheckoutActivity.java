    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // EditText room;
        ...
        for (int i = 0; i < merchModelList.size(); i++) {
            Log.e("DATA CHECKOUT ACTIVITY", merchModelList.get(i).getMerchName() + " " + merchModelList.get(i).getMerchDesc() + " " + merchModelList.get(i).getMerchSize() + " " + merchModelList.get(i).getMerchQty());
